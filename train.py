...
def train(opt):
    ...
    for name, param in model.named_parameters():
        if 'localization_fc2' in name:
            print(f'Skip {name} as it is aeady initialized')
            continue
        try:
            if 'bias' in name:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--saved_model', default='/home/jet981217/Downloads/TPS-ResNet-BiLSTM-Attn.pth', help="path to model to continue training")
